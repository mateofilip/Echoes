      ...
      <main className="flex h-dvh w-dvw flex-col justify-center px-5 sm:px-16 md:px-28 lg:px-52 xl:px-96 2xl:px-120">
        <div className="flex h-dvh flex-col justify-center gap-30">
          <div className="flex flex-col justify-between gap-20">
            <p
              className={`variableSize text-center transition-all duration-300 ease-in-out ${reloading ? "opacity-0" : "opacity-100"}`}
            >
              <span>«&nbsp;</span>
            ...
            <h2
              className={`text-right text-xl transition-all duration-300 ease-in-out md:text-2xl ${reloading ? "opacity-0" : "opacity-100"}`}
            >
        ...
        <div className="fixed right-0 bottom-0 left-0 mb-30 flex justify-center gap-2">
          ...
          >
            <svg
              ...
              className={`${isReloadingButton ? "rotate-240" : ""} transition-all duration-300`}
            >
              <path
