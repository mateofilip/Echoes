    ...
    <Drawer.Root direction="right" open={open} onOpenChange={onOpenChange}>
      <Drawer.Trigger asChild>
        ...
        >
          ...
          <div className="Geist pointer-events-none visible absolute bottom-10 -left-1 flex translate-y-2 flex-col items-start opacity-0 transition-all duration-200 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-300">
        ...
        <Drawer.Content className="fixed top-4 right-4 bottom-4 z-10 flex w-[calc(100vw-2rem)] overflow-x-hidden outline-none data-[state=closed]:![animation-duration:200ms] data-[state=open]:![animation-duration:200ms] sm:w-[420px]">
          <div className="flex h-full w-full grow flex-col overflow-hidden rounded-3xl border border-stone-800/90 bg-stone-950/95 p-5 shadow-2xl ring-1 shadow-black/40 ring-white/5 backdrop-blur-2xl ring-inset sm:p-6">
            <div className="flex items-center justify-between gap-4 border-b border-stone-800/80 pb-5">
              <div>
                <Drawer.Title className="Geist text-xl leading-none font-semibold tracking-tight text-orange-100 sm:text-2xl">
                  Saved Quotes
                </Drawer.Title>
              ...
              <div className="flex items-center gap-2">
                <span className="Geist text-xs font-medium text-orange-200/70 tabular-nums">
            ...
            <div className="Geist min-h-0 w-full flex-1 [scrollbar-width:none] overflow-x-hidden overflow-y-auto overscroll-contain pt-5 [&::-webkit-scrollbar]:hidden">
                ...
                >
                  {[...displayedQuotes].reverse().map((quote) => (
                    <motion.article
                      ...
                      exit="exit"
                      transition={cardTransition}
                      className="group relative origin-center overflow-hidden rounded-2xl border border-stone-800/90 bg-stone-900/60 p-5 shadow-lg shadow-black/10 transition-colors delay-0 duration-200 ease-out hover:border-orange-200/30 hover:bg-stone-900/85"
                    >
